...
const API = (process.env.REACT_APP_API_URL || "http://localhost:8080") + "/api/auth/register";
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const payload = {
        ...
        role: selectedRole,
        ...(selectedRole === "voter" && { voterId: formData.voterId }),
        ...
        <div className="glass-card">
          ...
          {selectedRole && (
            <>
              ...
              {/* ── ALL FIELDS INLINED — no sub-components to avoid remount bug ── */}
              <form onSubmit={handleSubmit} className="signup-form">
                ...
                {/* Org fields — only for organization */}
                {selectedRole === "organization" && (
                  <div className="field-row">
                    <div className="field-group">
                      ...
                      <input
                        type="text"
                        name="orgName"
                        placeholder="e.g. SPPU, Fergusson"
                ...
                {/* Plan picker — only for organization */}
                {selectedRole === "organization" && (

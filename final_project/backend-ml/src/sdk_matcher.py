...
def create_template_from_raw(raw_bytes: bytes, width: int, height: int) -> bytes:
    """
    Create an SG400 template directly from raw grayscale bytes.
    Normalizes to 300x400 if necessary.
    """

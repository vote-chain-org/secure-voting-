...
public class MlClientService {
     ...
     */
    public void enroll(String voterId, java.io.File pngFile, String rawPixelsB64, Integer width, Integer height) throws java.io.IOException {
        ...
        if (rawPixelsB64 != null) {
            builder.part("raw_pixels_b64", rawPixelsB64);
            builder.part("width", String.valueOf(width));
    ...
    public Map<String, Object> verifyWithId(String voterId, java.io.File pngFile, String rawPixelsB64, Integer width, Integer height) throws java.io.IOException {

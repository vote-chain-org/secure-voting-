...
public class AuthService {
    ...
    public AuthResponse register(RegisterRequest request) {
        ...
        if (role == null || (!role.equals("VOTER") && !role.equals("ADMIN"))) {
            role = "VOTER";
        }
        user.setRole(role);
        ...
        boolean enrolled = (user.getFingerprintRawB64() != null);
        return new AuthResponse(token, user.getEmail(), user.getFullName(), user.getRole(), enrolled);
    }

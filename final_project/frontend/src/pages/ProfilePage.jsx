...
const API = process.env.REACT_APP_API_URL || "http://192.168.0.112:8080";
...
export default function ProfilePage() {
  ...
  const verifications = [
    { icon: <MailIcon />, label: "Email Verified", status: true },
    {
      ...
      status: !!profile?.fingerprintEnrolled,
    },
    {
      icon: <ShieldIcon />,
                ...
                <input 
                  ...
                  onChange={async (e) => {
                    ...
                    try {
                      ...
                      // Update profile state to reflect enrollment
                      setProfile(p => ({...p, fingerprintEnrolled: true}));
                    } catch (err) {

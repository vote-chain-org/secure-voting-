...
const API = (process.env.REACT_APP_API_URL || "http://192.168.0.112:8080") + "/api/auth/register";
const ML_URL = (process.env.REACT_APP_ML_URL || "http://192.168.0.112:5000");
...
export default function SignupPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    // For voter/admin role, fingerprint is required
    if ((selectedRole === "voter" || selectedRole === "admin") && !fpRaw) {
      setError("Fingerprint scan is required for this role.");
      return;
    }
    ...
    try {
      ...
      const payload = {
        ...
        ...((selectedRole === "voter" || selectedRole === "admin") && { 
          ...
          {selectedRole && (
            <>
              ...
              <form onSubmit={handleSubmit} className="signup-form">
                ...
                {/* Voter ID + Fingerprint Scan — for voter and admin */}
                {(selectedRole === "voter" || selectedRole === "admin") && (
                  <>
                    <div className="field-group">

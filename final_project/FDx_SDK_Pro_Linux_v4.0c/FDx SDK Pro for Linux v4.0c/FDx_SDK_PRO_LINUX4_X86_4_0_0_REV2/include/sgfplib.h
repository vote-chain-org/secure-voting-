...
enum SGFDxTemplateFormat 
{
   ...
   TEMPLATE_FORMAT_ISO19794_COMPACT_NO_HEADER = 0x0500,
};
...
struct SGFPM
{
   ...
   // Algorithim: Only work with ISO19794 Compact Template (With Header)
   ...
   // Algorithim: Only work with ISO19794 Compact Template (No Header)
   virtual DWORD  WINAPI  MatchIsoCompactTemplateNoHeader(BYTE*  isoCompactTemplateNoHeader1,  BYTE*  isoCompactTemplateNoHeader2, DWORD secuLevel, BOOL*  matched) = 0;
   virtual DWORD  WINAPI  GetIsoCompactNoHeaderMatchingScore(BYTE*  isoCompactTemplateNoHeader1, BYTE* isoCompactTemplateNoHeader2, DWORD* score) = 0;
   virtual DWORD  WINAPI  CreateIsoCompactTemplateNoHeader(SGFPImageInfo* fpImageInfo, BYTE* rawImage, BYTE*  minTemplate, DWORD maxMinutiae, DWORD* templateSize) = 0;
...
// Algorithim: Only work with ISO19794 Compact Template (No Header)
SGFPM_DLL_DECL DWORD  WINAPI  SGFPM_MatchIsoCompactTemplateNoHeader(HSGFPM hFpm, BYTE*  isoCompactTemplateNoHeader1,  BYTE*  isoCompactTemplateNoHeader2, DWORD secuLevel, BOOL*  matched);
SGFPM_DLL_DECL DWORD  WINAPI  SGFPM_GetIsoCompactNoHeaderMatchingScore(HSGFPM hFpm, BYTE*  isoCompactTemplateNoHeader1, BYTE* isoCompactTemplateNoHeader2, DWORD* score);
SGFPM_DLL_DECL DWORD  WINAPI  SGFPM_CreateIsoCompactTemplateNoHeader(HSGFPM hFpm, SGFPImageInfo* fpImageInfo, BYTE* rawImage, BYTE*  minTemplate, DWORD maxMinutiae, DWORD* templateSize);
